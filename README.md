...
### COMPETITORS
---
TradingView runs on PC, Mac, Tablets, and Smartphones and requires Zero Installation, it simply works.  The Market data is vast, covering nearly all Stock Markets, and it includes Stock, ETF’s Futures, Foreign Exchange & Bonds, all at no extra price, which means outstanding value for money combined with excellent support options.Also, a huge benefit is that the Data Speed and Coverage are mind-blowing, covering literally every stock market on the planet and not just stocks but a lot more. For  Pro, Pro+ & Premium members, you will get the fastest dataflow possible with your data subscription.
...
![COMPETITORS](
   https://github.com/Ogzhnacl/FINTECH-HOMEWORK1/blob/main/competatior.PNG)
...
![PRICING](
   https://github.com/Ogzhnacl/FINTECH-HOMEWORK1/blob/main/PRICING.PNG)
